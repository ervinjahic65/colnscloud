;(function (w) {
  ...
  destjs.src = 'https://x.clearbitjs.com/v2/pk_a62936f26f3fcfe9f838fe67fb72ee09/destinations.min.js';
  ...
  first.parentNode.insertBefore(destjs, first);
      ...
      w.clearbit._writeKey = 'pk_a62936f26f3fcfe9f838fe67fb72ee09';
      ...
      if (!tracking.initialize) {
        if (tracking.invoked) {
          ...
          clearbitjs.src = 'https://x.clearbitjs.com/v2/pk_a62936f26f3fcfe9f838fe67fb72ee09/tracking.min.js';
    ...
    formsjs.src = 'https://x.clearbitjs.com/v1/pk_a62936f26f3fcfe9f838fe67fb72ee09/forms.js?page_path=' + encodeURIComponent(path);
